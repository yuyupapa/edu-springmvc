...
<head>
    ...
    <script type="text/javascript" src="${ctx}/resources/club/js/open.js"></script>
</head>
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="well">
                ...
                <form class="form-horizontal" id="open-form">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">클럽명</label>

                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="clubName" placeholder="클럽명">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <button type="submit" class="btn btn-primary">클럽개설</button>
