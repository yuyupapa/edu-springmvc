...
public class ClubMemberMyBatisPersisterTest extends BaseMyBatisPersisterDbUnitTest {
	//
	@Autowired
	private ClubMemberMyBatisPersister persister;
	...
	public void testDelete() {
		...
		ClubMember member = persister.retrieve("1", "hyunohkim@nextree.co.kr");
