...
public class ClubMyBatisPersisterTest extends BaseMyBatisPersisterDbUnitTest {
	//
	@Autowired
	...
	public void testChangeAdmin() {
		...
		//
		ClubAdmin resultAdmin = clubPersister.retreiveAdmin("1");
		assertThat("2", is(resultAdmin.getId()));
		assertThat("hong@testcaese.com", is(resultAdmin.getEmail()));
		assertThat("홍반장", is(resultAdmin.getName()));
	}
